...
export const trustFeatures = [
  {
    ...
    description: "Stays shiny for years — or we replace it.",
  },
  {
    icon: "Droplets",
    title: "Waterproof & Sweatproof",
    description: "Shower, gym, pool — no damage ever.",
  },
  {
    icon: "Heart",
    title: "100% Skin Safe",
    description: "Nickel-free. Zero irritation. Guaranteed.",
  },
  {
    icon: "RotateCcw",
    title: "7-Day Easy Returns",
    description: "Don't love it? Full refund. No questions.",
  },
  {
    icon: "Banknote",
    title: "COD Available",
    description: "Pay at your doorstep. Cash or UPI.",
  },
];
