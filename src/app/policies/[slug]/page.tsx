...
> = {
  ...
  returns: {
    title: "Return Policy",
    content: [
      "We want you to love your Lunara jewellery. If for any reason you're not satisfied, we offer a hassle-free return policy.",
      ...
      "**How to Return:** Contact our support team at hello@lunara.in or call +91 98765 43210. We'll arrange a pickup at no extra cost.",
  ...
  privacy: {
    ...
    content: [
      "At Lunara, we take your privacy seriously. This policy explains how we collect, use, and protect your personal information.",
      ...
      "**Your Rights:** You can request access to, correction of, or deletion of your personal data at any time by contacting us at hello@lunara.in.",
  ...
  terms: {
    ...
    content: [
      "Welcome to Lunara. By accessing our website and making a purchase, you agree to the following terms.",
      ...
      "**Intellectual Property:** All content on this website, including images, text, logos, and designs, is the property of Lunara and is protected by copyright law.",
      "**Limitation of Liability:** Lunara shall not be liable for any indirect, incidental, or consequential damages arising from the use of our website or products.",
      ...
      "For any questions about these terms, please contact us at hello@lunara.in.",
    ],
  },
};
    ...
    <div className="bg-ivory min-h-screen">
      ...
      <div className="luxury-container py-10 md:py-16">
        <div className="max-w-3xl mx-auto">
          <h1 className="font-serif text-heading-1 sm:text-display text-neutral-900 mb-6 sm:mb-10">
            {policy.title}
          </h1>
