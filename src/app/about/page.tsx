    ...
    <div className="bg-ivory">
      ...
      <section className="relative h-[40vh] sm:h-[50vh] md:h-[60vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-4">
          <div>
            ...
            <h1 className="font-serif text-heading-1 sm:text-display md:text-display-xl text-ivory mt-2 sm:mt-3">
              About Lunara
            </h1>
          </div>
        </div>
      ...
      <section className="section-padding">
        <div className="luxury-container max-w-3xl mx-auto text-center">
          <h2 className="font-serif text-heading-2 sm:text-heading-1 text-neutral-900 mb-4 sm:mb-6">
            Jewellery That Lasts
          </h2>
          <p className="text-body-sm sm:text-body text-neutral-500 leading-relaxed mb-4 sm:mb-6">
            Lunara was born from a simple frustration — beautiful jewellery that
          ...
          <p className="text-body text-neutral-500 leading-relaxed mb-6">
            ...
            the gym to the boardroom, from beach days to date nights — Lunara
          ...
          <p className="text-body text-neutral-500 leading-relaxed">
            ...
            quiet, confident, and enduring. That&apos;s the Lunara promise.
          </p>
        </div>
      </section>
      ...
      <section className="section-padding bg-cream">
        <div className="luxury-container">
          <div className="text-center mb-8 sm:mb-14">
            <h2 className="font-serif text-heading-2 sm:text-heading-1 text-neutral-900">
              What We Stand For
            </h2>
          </div>
      ...
      <section className="section-padding">
        <div className="luxury-container text-center">
          <h2 className="font-serif text-heading-2 sm:text-heading-1 text-neutral-900 mb-4">
            Ready to Shine?
          </h2>
